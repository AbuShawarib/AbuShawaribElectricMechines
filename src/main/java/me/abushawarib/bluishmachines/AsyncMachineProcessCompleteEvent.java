...
public class AsyncMachineProcessCompleteEvent extends Event {
    ...
    private final NonElectricAContainer container;
    private final MachineRecipe machineRecipe;

    public AsyncMachineProcessCompleteEvent(@Nonnull Location l, @Nullable NonElectricAContainer container, @Nullable MachineRecipe machineRecipe) {
        super(true);
     ...
     */
    @Nullable
    public NonElectricAContainer getMachine() {
        return container;
    }
