...
/**
 * The {@link CobbleGen} is an non electric version of the standard miner
 * android {@link Smeltery}.
 * 
 * @author AbuShawarib
 *
 */
public class CobbleGen extends NonElectricAContainer {
    ...
    public CobbleGen(
        ...
        super(
            ...
            new SlimefunItemStack(
                        "COBBLE_GENERATOR_" + rank, Material.BLACKSTONE,
                        "&7Cobblestone Generator (" + rank + ")",
                        " ",
        ...
        registerRecipe(
            40,
            new ItemStack[] {
                new ItemStack(Material.DRIED_KELP_BLOCK, 2),
                new ItemStack(Material.LAVA_BUCKET),
                new ItemStack(Material.LAVA_BUCKET)
            },
            new ItemStack[] { 
        ...
        Research research = new Research(
                new NamespacedKey(plugin, "COBBLE_GENERATOR" + rank),
                ("COBBLE_GENERATOR_" + rank).hashCode(), //This is unique id for research
                "Automatic Stone Generation " + rank,
                researchCost
        );
